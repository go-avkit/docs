...
An audio/video toolkit — MP4/ISO-BMFF and Matroska/WebM demuxing.

Part of the **Graphics, images & media** family of the
...
- **[Modules](modules.md)** — every module in go-avkit, with its source and its reference.
